...
import { User, ShoppingBag, Send, MessageSquare, MessageCircle } from 'lucide-react';

export default function BuyerLayout({ children }: { children: React.ReactNode }) {
  const pathname = usePathname();

  const sidebarItems = [
    { name: 'Profile', href: '/buyer', icon: User },
    { name: 'Active Orders', href: '/buyer/orders', icon: ShoppingBag },
    { name: 'Enquiries', href: '/buyer/enquiries', icon: Send },
    { name: 'Admin Chat', href: '/buyer/chat', icon: MessageSquare },
  ];
