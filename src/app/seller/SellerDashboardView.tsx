...
import { User, ClipboardList, Landmark, ShoppingCart, Edit2, ShieldAlert } from 'lucide-react';
...
export default function SellerDashboardView({
  ...
  const [formData, setFormData] = useState({
    ...
    category: profile.category || 'MANUFACTURER',
  });
  ...
  // Determine if profile fields are unconfigured
  ...
  return (
    <div className="space-y-6">
      ...
      {!isVerified && (
        <div className="bg-blue-50 border border-blue-200 text-blue-900 rounded-lg p-4 font-semibold text-sm flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span>
              {isProfileSkeleton 
                ? 'Your profile information is incomplete. Complete your profile details to submit for verification.' 
                : 'Your profile has been submitted. Pending admin credential review.'}
            </span>
          </div>
      ...
      {/* 2. PROFILE DETAILS VIEW / EDIT TOGGLE CARD */}
      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        {!isEditing ? (
          <div className="flex flex-col lg:flex-row justify-between gap-8">
            
            {/* Display Mode: Information Fields Grid */}
            <div className="flex-1 space-y-6">
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <h2 className="text-2xl font-bold text-gray-900">
                    {profile.companyName || "Unnamed Organization"}
                  </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-6 text-sm text-gray-500 mt-2">
                  <span className="flex items-center gap-1.5 font-medium">
                    <User className="w-4 h-4 text-gray-400" /> {profile.name || 'Unnamed Personnel'}
                  </span>
                  <span>&bull;</span>
                  <span>{userEmail}</span>
                  <span>&bull;</span>
              ...
              {/* Specification parameters mapping */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 pt-4 border-t border-gray-100">
                ...
                <div>
                  <span className="text-xs font-bold uppercase tracking-wider text-gray-400 block mb-0.5">Category</span>
                  <p className="text-sm font-semibold text-gray-800 uppercase">{profile.category || 'MANUFACTURER'}</p>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-sm font-semibold text-gray-800 leading-relaxed">
                    {profile.companyDescription || 'No description available. Please add a detailed description of your company, products, services, and business operations.'}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-64 flex flex-col items-center justify-between border-t lg:border-t-0 lg:border-l border-gray-100 pt-6 lg:pt-0 lg:pl-8">
              ...
              <div className="text-center mt-4">
                ...
                <p className="text-xs text-gray-400">{profile.designation || 'Designation'}</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-950 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
                  placeholder="e.g. Acme Pharmaceuticals"
                />
              </div>
              <div>
                <label className="block text-xs font-bold uppercase text-gray-400 mb-1">Authorized Contact Name *</label>
                <input
                  type="text"
                  required
                  value={formData.name}
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-955 outline-none"
                >
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-955 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
                  placeholder="Describe trade category, specialized active ingredients, or manufacturing capacity..."
                />
              </div>
            </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center gap-4">
            ...
            <div>
              <span className="text-xs text-gray-400 font-bold uppercase tracking-wider block">Total Items</span>
              <span className="text-2xl font-bold text-gray-900">{metrics.totalItems}</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm flex items-center gap-4">
            ...
            <div>
              ...
              <span className="text-2xl font-bold text-gray-900">₹{metrics.totalRevenue.toLocaleString('en-IN')}</span>
            </div>
          </div>
